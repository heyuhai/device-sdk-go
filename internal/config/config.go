...
import (
	"edgeGateway/internal/pkg/configuration"
	"edgeGateway/internal/pkg/db/mysql"
	"edgeGateway/internal/pkg/modle"
...
type ConfigurationStruct struct {
	...
	// TODO: 增加自定义配置
	Logger          modle.LoggerStruct
	Mysql           mysql.MysqlConfigStruct
	Systeminfo      configuration.Systeminfo
	CustomDeviceSrv configuration.CustomDeviceSrv
}
